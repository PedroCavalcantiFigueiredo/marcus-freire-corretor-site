...
import { Bed, Bath, Square, MapPin, AlertCircle, Car, Home, Info } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 space-y-4">
            ...
            <p className="text-lg text-muted-foreground text-pretty">
              Confira nossa seleção de imóveis cuidadosamente escolhidos para você. Entre em contato para agendar uma
              visita.
            </p>
          </div>
